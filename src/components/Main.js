...
export default function Main() {
  ...
  return (
    ...
    <div className='positionSticky d-flex flex-row justify-content-sm-around justify-content-between mt-4 mx-4 mx-x-0'>
        ...
        <div className='nav-menu d-sm-flex d-none justify-content-center align-items-center'>
            ...
            <nav className='nav-main d-flex flex-row'>
                ...
                <ul className='nav-content d-flex flex-row justify-content-around p-0 m-0'>
                    <li><a  id='about' className="nav-text active" onClick={navChange} href="#scrollspyHeading5">About</a></li>
                    <li><a  id='projects' className="nav-text" onClick={navChange} href="#scrollspyHeading1">Projects</a>
                    </li>
                    <li><a  id='qualification' className="nav-text" onClick={navChange}
                            href="#scrollspyHeading2">Qualification</a></li>
                    <li><a  id='skills' className="nav-text" onClick={navChange} href="#scrollspyHeading3">Skills</a>
                    </li>
                    <li><a  id='contactUs' className="nav-text" onClick={navChange} href="#scrollspyHeading4">Contact Us</a>
                    </li>
                </ul>
        ...
        <div id="smNavItems" className="navItemsForSm p-4 rounded-4">
            <ul className='nav-content d-flex flex-column justify-content-around p-0 m-0'>
                <li><a id='a' className="nav-text fs-3" onClick={onClickVisibilityChange} href="#scrollspyHeading5">About</a></li>
                <li><a id='b' className="nav-text fs-3" onClick={onClickVisibilityChange} href="#scrollspyHeading1">Projects</a></li>
                <li><a id='c' className="nav-text fs-3" onClick={onClickVisibilityChange} href="#scrollspyHeading2">Qualification</a></li>
                <li><a id='d' className="nav-text fs-3" onClick={onClickVisibilityChange} href="#scrollspyHeading3">Skills</a></li>
                <li><a id='e' className="nav-text fs-3" onClick={onClickVisibilityChange} href="#scrollspyHeading4">Contact Us</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    {/* --------------------------Projects Start-------------------------------- */}
    <div id="scrollspyHeading1" className='default-margin-x-y d-flex justify-content-center align-items-center flex-column'>
    ...
    {/* -----------------------------Qualification Start------------------------- */}
    <div id="scrollspyHeading2" className='default-margin-x-y d-flex justify-content-center align-items-center flex-column'>
    ...
    {/* -----------------------------Qualification End------------------------- */}
     ...
     {/* -----------------------------Skills Start------------------------- */}
    <div id="scrollspyHeading3" className='default-margin-x-y d-flex justify-content-center align-items-center flex-column'>
    ...
    {/* -----------------------------Contact Us Start------------------------- */} 
    <div id="scrollspyHeading4" className='default-margin-x-y d-flex justify-content-center align-items-center flex-column'>
